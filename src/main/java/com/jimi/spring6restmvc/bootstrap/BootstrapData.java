package com.jimi.spring6restmvc.bootstrap;
...
import com.jimi.spring6restmvc.repositories.CustomerRepository;
...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.out.println("its so nice  have this written when it boots ");
        loadBeerData();
        loadCustomerData();
    }
